...
func getCustomer(t *testing.T, importer, firstName, lastName string, phone []string, mail []string, addr []*customerv1.Address) (*customerv1.Customer, []*customerv1.ImportState) {
	...
	patcher := NewCustomerPatcher(importer, "ref", "AT", new(resolver), new(customerv1.Customer), nil)
...
func Test_Patch_Empty(t *testing.T) {
	...
	patcher := NewCustomerPatcher("test", "ref", "AT", new(resolver), existing, nil)
...
func TestPruneAttributes(t *testing.T) {
	...
	p := NewCustomerPatcher("test", "ref", "AT", new(resolver), existingCustomer, existingStates)
...
func TestPriority(t *testing.T) {
	...
	p := NewCustomerPatcher("foo", "ref", "AT", new(resolver), existingCustomer, existingStates)
